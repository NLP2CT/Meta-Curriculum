...
class SacrebleuScorer(object):
    ...
    def compute_bleu(self, correct, total, sys_len, ref_len, smooth_method='none',
                     smooth_value=None, use_effective_order=False):
        return self.sacrebleu.compute_bleu(correct=correct, total=total, sys_len=sys_len, ref_len=ref_len,
    ...
    def result_string(self, order=4):
        if order != 4:
            raise NotImplementedError
        return self.sacrebleu.corpus_bleu(self.sys, [self.ref], lowercase=self.lowercase)
